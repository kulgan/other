...
tcga = ['TCGA-BRCA','TCGA-GBM','TCGA-OV','TCGA-LUAD','TCGA-UCEC','TCGA-KIRC','TCGA-HNSC','TCGA-LGG','TCGA-THCA','TCGA-LUSC','TCGA-PRAD','TCGA-SKCM','TCGA-COAD','TCGA-STAD','TCGA-BLCA','TCGA-LIHC','TCGA-CESC','TCGA-KIRP','TCGA-SARC','TCGA-LAML','TCGA-ESCA','TCGA-PAAD','TCGA-PCPG','TCGA-READ','TCGA-TGCT','TCGA-THYM','TCGA-KICH','TCGA-ACC','TCGA-MESO','TCGA-UVM','TCGA-DLBC','TCGA-UCS','TCGA-CHOL']
...
for project in tcga:
    ...
    for sar in sars:
        ...
        sample = aliquot._AliquotDerivedFromAnalyte_out[0].dst._AnalyteDerivedFromPortion_out[0].dst._PortionDerivedFromSample_out[0].dst
        ...
        sarData.loc[i] = [project, \
                         ...
                         case.submitter_id]
        i = i + 1
sarData.to_csv('tcga.sar.tsv', sep='\t', encoding='utf-8')
...
for project in tcga:
    ...
    for ar in ars:
        ...
        arData.loc[i] = [ar.node_id, \
                         ...
                         cocleanWf.node_id]
        i = i + 1
arData.to_csv('tcga.ar.tsv', sep='\t', encoding='utf-8')
...
for project in tcga:
    ...
    for ssm in ssms:
        ...
        ssmData.loc[i] = [ssmWf.node_id, \
                          ...
                          ar2.node_id]
        i = i + 1
ssmData.to_csv('tcga.vcf.tsv', sep='\t', encoding='utf-8')
