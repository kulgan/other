...
s1 <- fread("ucec.seg133.v1.gistic.seg.txt")
names(s1) = c("aliquot", "chr", "start", "end", "nprobe", "segmean")
s2 <- fread("ucec.seg133.v2.gistic.seg.txt")
names(s2) = c("aliquot", "chr", "start", "end", "nprobe", "segmean")
s3 <- fread("ucec.seg133.v3.gistic.seg.txt")
names(s3) = c("aliquot", "chr", "start", "end", "nprobe", "segmean")
